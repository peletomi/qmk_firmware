...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_A_AA]  = ACTION_TAP_DANCE_FN(accent_a)
 ...
 * |--------+-------+--------+-------+-------+-------+---------|          |-------+-------+--------+--------+--------+-------+--------|
 * |        |   Q   |    W   |   F   | P GCA | B GCSA|   Tab   |          |  ( )  |   J   |   L    |   U    |   Y    |   ;   |   \    |
 * |--------+-------+--------+-------+-------+-------|         |          |       |-------+--------+--------+--------+-------+--------|
 * |        |   A   |    R   | S CA  | T CS  |   G   |---------|          |-------|   H   |   N    |   E    |   I    | O L2  |   '    |
 * |--------+-------+--------+-------+-------+----- -|  [      |          |  ]    |-------+--------+--------+--------+-------+--------|
 * | MShift | Z Ctrl|    X   |   C   |   D   |   V   |         |          |       |   K   |   M    |   ,    |   .    |/ Ctrl | )Shift |
 * `--------+-------+--------+-------+-------+-------+---------'          `--------------+---------+--------+--------+-------+--------'
 *   |  Home |  PgUp  |  PgDn |  End |Ins L2 |                                           | Left  | Down   |  Up    | Right | ~L1  |
 *   `---------------------------------------'                                           `----------------------------------------'
 *                                             ,---------------.          ,----------------.
 *                                             |      | ` Gui  |          |  L1   |   L2   |
 *                                     ,-------|------|--------|          |-------+--------+-------------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TRNS,        KC_Q,         KC_W,     KC_F,    LCAG_T(KC_P), HYPR_T(KC_B),   KC_TAB, // KC_LPRN, KC_RPRN
        KC_TRNS,        TD(TD_A_AA),         KC_R,     LCA_T(KC_S),  C_S_T(KC_T),    KC_G,
        OSM(MOD_LSFT),  CTL_T(KC_Z),        KC_X,     KC_C,    KC_D,    KC_V,   KC_LBRC,
        KC_HOME,      KC_PGUP,  KC_PGDN, KC_END,      LT(MDIA, KC_INS),
                                               KC_TRNS, GUI_T(KC_GRV),
                                                              KC_DEL,
...
[MDIA] = LAYOUT_ergodox(
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, LGUI(KC_W), LGUI(KC_E), LGUI(KC_S), KC_TRNS, KC_TRNS,
       KC_TRNS, LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
